...
I dag spør du sjefen: «Når kommer Max tilbake?»
...
Effektivt. Han må være midt i noe viktig.

Du sjekker profilen hans. Ingenting, bortsett fra tittel: «Koordinator».

Koordinator av hva? Du spør Irina.

«Åh, Max koordinerer det meste, egentlig.»
...
Men på fellesmøtet sier sjefen: «Det tar Max seg av.»

HR-sjefen nikker: «Ja, Max har kontroll.»
...
«Er det sunt?» spør du sjefen.

«Hva mener du?»

«All den arbeidsmengden. På én person.»

Sjefen ser forvirret ut. «Max håndterer det. Som alltid.»
...
Venter fortsatt? Du får en urolig følelse. Har noe skjedd med Max som ingen vil snakke om?`
			},
			{
				previousChoice: "B",
...
HR-sjefen kremter. «Max er en komplisert sak.»

«Komplisert hvordan? Er han syk?»

Pause. «Det er personalsak. Jeg kan ikke si mer.»
...
Du må finne ut hva som skjedde med ham.`
		...
		quiz: {
			...
			options: [
				{ letter: "A", text: "Konfronterer sjefen om Max" },
	...
	},
	{
		...
		variants: [
			{
				previousChoice: "A",
				content: `Du konfronterer sjefen.

«Jeg er bekymret for Max. Hvor er han egentlig?»

Sjefen sukker. «Max er tilgjengelig. På sin måte.»
...
Sjefen ser deg i øynene. «Noen ting er best å ikke grave i.»

Du fryser. Er dette en trussel? Eller en advarsel?

Hva har skjedd med Max som er så alvorlig at sjefen ikke vil snakke om det?`
			},
			{
				previousChoice: "B",
...
Ble Max overveldet? Ble han presset ut?`
			}
		],
		quiz: {
...
Max donerte dette. Du henger opp lysene hans i vinduet. De blinker varmt.
...
Harald tenker lenge. «Snill. Hjelpsom. Tok alltid på seg ekstra.»
...
Kenneth ser på deg. «Godt spørsmål. Vil du at jeg skal sjekke?»
...
Du finner en e-post fra sjefen til hele teamet, sendt for tre måneder siden:

**«Max tar seg av Q4-rapporten.»**

Men Q4-rapporten ble aldri levert. Du sjekket.
...
Sjefen skrev: **«Vi må holde Max-situasjonen intern.»**
...
Hodet spinner.`
		...
		quiz: {
			...
			options: [
				{ letter: "A", text: "Konfronterer sjefen igjen, denne gangen hardere" },
	...
	},
	{
		...
		variants: [
			{
				previousChoice: "A",
				content: `Du konfronterer sjefen igjen.

«Jeg vet at Max-situasjonen holdes skjult. Jeg har sett e-postene.»

Sjefen blir blek. «Du har vært i arkivene?»

«Jeg vil bare vite at Max har det bra.»

Lang pause. Sjefen gnir seg i ansiktet.
...
Irina ser bekymret ut. «Jeg har lurt selv. Men jeg turte aldri spørre.»`
			},
			{
				previousChoice: "C",
...
Hun tenker. «Det er lenge siden. Kanskje noen år?»
...
Du finner Kenneth igjen. «Kan du grave mer i Max sin konto?»

Han nøler. «Det er egentlig ikke lov.»
...
Hjertet ditt hamrer. Hva har du avdekket?`
			}
		],
		quiz: {
...
«Hvem får Max sin lønn?» spør du regnskapssjefen.

Hun stivner. «Det er konfidensielt.»
...
Du tenker på alle oppgavene: Det vanskelige. Det ingen vil gjøre. Alt som skyves bort.
...
«Max er en verdifull ressurs,» sier sjefen.

«En ressurs jeg aldri har sett.»

HR-sjefen: «Max jobber på sin måte.»

«Hvilken måte? Usynlig?»

Stille. Så: «Vi setter pris på engasjementet ditt, men dette er ikke din sak.»
...
Hun sjekker registrene. Rynker pannen.

«Vi har ingen Max M. registrert som medlem.»

«Han er kanskje ikke organisert?»
...
«Max M.?» Klikking på tastatur. «Vi har ingen med det navnet.»

«Han har jobbet her i årevis. Alle kjenner ham.»

Pause. «Jeg beklager. Det finnes ingen Max M. i våre systemer.»
...
Hun ler nervøst. «Det er jo sprøtt.»
...
Hun blir stiv. «Det var en del av onboarding-pakken. For å skape kultur.»
...
Og nå er han borte. Ikke død, men aldri født.
...
Dina Hansen. Det navnet kjenner jeg igjen. Du finner HR sjefen. «Hvorfor står det en kopp på Max sin pult hver dag?»

Hun sukker tungt. «Jeg satte den ut. Hver morgen. For å opprettholde fasaden.»
...
Ledelsen orkestrerte det hele. Fra dag én.`
			...
			{
				previousChoice: "C",
				content: `Du er sint. Systemet lurte alle.
...
**«Enig. Sparer oss for én stilling i budsjettet.»** – HR
...
«Jeg satte ut koppen,» innrømmer HR sjefen foran alle. «Hver morgen. For å opprettholde illusjonen.»
...
«Oppgavene ble jo gjort. På et vis.»

«Nei. De hopet seg opp. Se på mappen. Årevis med uløste oppgaver. Tildelt et spøkelse.»

Stillhet. Så tar Harald ordet:

«Han har rett. Vi har alle latt dette skje.»
...
Sjefen tar ordet: «Vi trenger en ekte koordinator. Noen som faktisk finnes.»
...
«Fra nå av: Ingen flere Max-er,» sier sjefen. «Klare ansvarsområder på ekte mennesker.»

«Og vi spør,» legger du til. «Når noe virker rart, spør vi.»

Irina smiler. «Takk for at du spurte. Selv om vi ikke ville svare.»

Du smiler tilbake. Det føles som en avslutning. Og en begynnelse.`
			},
			{
				previousChoice: "C",
				content: `Besluttsomheten tar over.

«Vi lager nye rutiner,» sier sjefen. «Ingen oppgaver uten en som er ansvarlig.»

«Årlig gjennomgang av roller,» foreslår HR sjefen.

«Og en kultur for å spørre,» legger du til.
...
Sjefen ser på listen. «Det fordeler vi på teamet. Rettferdig.»
...
Du smiler. Endring er mulig. Selv her.`
		...
		quiz: {
			question: "Lille julaften nærmer seg. En siste refleksjon:",
			options: [
				{ letter: "A", text: "Du er glad du tok sjansen" },
				{ letter: "B", text: "Du håper lærdommen varer" },
				{ letter: "C", text: "Du ser frem til en normal arbeidsdag" }
			]
		}
	},
	{
...
Telefonen lyser opp. Telefonen vibrerer. Irina sender melding:

*«Vi har laget en intern regel. Den heter Max-regelen: Aldri anta at noen tar ansvar. Alltid spør.»*
...
Max lever videre. Ikke som en person, men som en påminnelse. Det føles riktig.`,
		...
		quiz: {
			...
			options: [
				{ letter: "A", text: "Takknemlig for mysteriet, rart nok" },
				{ letter: "B", text: "Lettet over at det er over" },
...
*«God jul alle sammen! Her er til et nytt år uten Max-er!»* – sjefen
...
*God jul.*`
		...
		quiz: {
			question: "Året ebber ut. Hva tar du med deg videre?",
			options: [
